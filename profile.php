...
<body>
    ...
    <div class="profile-container" id="events" style="display: block; background-color: ;">
      ...
      <div style="background-color: ; -webkit-box-shadow: 1px 1px 4px 0px rgba(34, 60, 80, 0.2);
      -moz-box-shadow: 1px 1px 4px 0px rgba(34, 60, 80, 0.2);
      box-shadow: 1px 1px 4px 0px rgba(34, 60, 80, 0.2); height: 600px; max-width: 1748px; ">

        <div style="background-color: ; height: 600px; max-width: 1748px; display: flex;">
          <div style="background-color: ; height: 600px; width: 500px; ">
              ...
              <li class="profile-card">
                ...
                <p class="profile-name">
                   <?php echo $user["name"];  echo $user["surname"]?>
          ...
          <div style="background-color: ; height: 600px; width: 800px">
          ...
          <div style="background-color: ; height: 600px; width: 450px">
            <li class="profile-card">
      ...
      <div style="background-color: ;  margin-top: 40px; height: 700px; max-width: 100%;">
          <?php 
            if ($userproj["userid"] != ""){
        ...
        box-shadow: 1px 1px 4px 0px rgba(34, 60, 80, 0.2);">
          <h2 class="service-subtitle" style="font-size: 28px; ">
            Название
          </h2>
          <p class="service-descr" style="font-size: 20px;">
            Автор:
        ...
        <div style="max-width: 1400px">
          ...
          grid-template-columns: repeat(3, 1fr);">
            ...
            <div style="background-image: url('img/hero.jpg'); background-size: cover; background-repeat: no-repeat;background-position: center; height: 240px; width: 100%; "> 
    ...
    <a href=""><button class="header-btn header-btn-ex">Начать проект</button></a>
